@section('footer')
  <div class="row py-8 justify-content-center footer">
    ...
    <div class="col-md-6 col-6 d-flex aboutUsBox">
      <div class="aboutUs w-100 w-md-50">
        ...
        <a href="/aboutYFP" class="mb-3 text-decoration-none d-block text-dark link">關於我們</a>
        <a href="/serviceterm" class="mb-3 text-decoration-none d-block text-dark link">服務使用條款</a>
        <a href="/privacyterm" class="mb-3 text-decoration-none d-block text-dark link">隱私保護條款</a>
      </div>
    ...
    <div class="col-md-3 px-0 mx-0 contactUsBox">
      ...
      <div class="d-flex align-items-center socialIconBox my-2">
